...
s8 = "1340213512.257      0 144.32.34.117 NONE/400 3423 GET http://[fe80::215:99ff:fe4a:3d45%2513]:456/SmartPanel/sm.xml?seq=2 - NONE/- text/html"
...
testList = [testFn "ClientIP" "144.32.71.165"                clientIP          s1
            ...
            ,testFn "scheme"   NONE                          (scheme . uri)    s6
            ,testFn "vhost"    "error:request-too-large"     (vhost . uri)     s6
            ,testFn "vhost"    "fe80::215:99ff:fe4a:3d45%2513" (vhost . uri)   s7
            ,testFn "port"     80                            (port . uri)      s7
            ,testFn "path"     "/SmartPanel/sm.xml"          (uriPath . uri)   s7
            ,testFn "port"     456                           (port . uri)      s8
            ,testFn "path"     "/SmartPanel/sm.xml"          (uriPath . uri)   s8
            ,testFail x
           ]
